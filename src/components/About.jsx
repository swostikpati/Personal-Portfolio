...
const About = () => {
  return (
    <>
      ...
      >
        I am Swostik Pati, a double major in Computer Science and Interactive
        Media with minors in Economics and Design, from New York University Abu
        Dhabi. I work at the intersection of tech, users, and the market in
        roles like Product Manager, Full-stack web developer (MERN/Next.js),{" "}
